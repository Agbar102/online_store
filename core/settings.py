...
MIDDLEWARE = [
    ...
    'core.middlewares.user_activity_middleware.UserActivityMiddleware',
]
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Документация для backend интернет-магазина',
    'VERSION': '1.0.0',
...
LOGGING = {
    ...
    'loggers': {
        'django': {
            'handlers': ['console'],
            'level': 'INFO',     # или DEBUG для подробного вывода
            'propagate': True,
        },
        'myapp': {
            'handlers': ['console'],
